...
if control == "h" or control ==  "cheat" or control ==  "c" or control ==  "b" or control ==  "b1" or control ==  "s" or control ==  "x10" or control ==  "no x10" or control ==  "b2":
    ...
    if control == "b":
        ...
        print(f"  You have {buil02} buidlings2, building1 will cost u {price_buil02}, in x10 mode 10 building2 will cost you {x10price_buil02}, you can buy it by typing (b2), buildings1 gain u {gain_buil02}")
