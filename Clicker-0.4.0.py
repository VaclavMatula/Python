...
price_buil01 = 5+(0.1*buil01)
x10price_buil01 = 50+(1*(buil01 + 5))
...
if control == "h" or control ==  "cheat" or control ==  "c" or control ==  "b" or control ==  "b1" or control ==  "s" or control ==  "x10" or control ==  "no x10":
    if control == "h":
    ...
    if control == "b":
        print(f"\n BUY MENU: \n If you want to buy 10 buildings at once, you can type (x10).\n You have {buil01} buidlings1, building1 will cost u {price_buil01}, in x10 mode 10 building1 will cost you {x10price_buil01}, you can buy it by typing (b1), buildings1 gain u {gain_buil01} \n")
