...
if control == "h" or control ==  "cheat" or control ==  "t" or control ==  "b" or control ==  "b1" or control ==  "s" or control ==  "x10" or control ==  "no x10" or control ==  "b2" or control ==  "b3" or control ==  "achi" or control ==  "up" or control == "pause":
    if control == "h":
       print ("Welcome to army typer! \n If you want to start new game, type (s). If you want to get a point, type (t). If you want to open buy menu, you can type (b). If you want to open achivements menu, you can type (achi). If you want to open upgrade menu, you can type (up). If you want to pause the game, you can type (pause).")
