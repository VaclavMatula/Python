...
gain_buil02 = 4*buil02
gain_buil02 = round(gain_buil02,1)


gain_together = gain_buil01 + gain_buil02
...
if control == "h" or control ==  "cheat" or control ==  "c" or control ==  "b" or control ==  "b1" or control ==  "s" or control ==  "x10" or control ==  "no x10" or control ==  "b2":
    ...
    if control == "b":
        ...
        print(f"  You gain {gain_together} each run !")
        ...
        print(f"  You have {buil02} buidlings2, building2 will cost u {price_buil02}, in x10 mode 10 building2 will cost you {x10price_buil02}, you can buy it by typing (b2), buildings2 gain u {gain_buil02}")
