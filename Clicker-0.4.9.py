...
def into_dict ():
    global vars
    for variable in ["points", "buil01", "buil02", "buil03", "buil04", "buil05", "buil06", "buil07", "buil08", "buil09", "buil10", "achi01", "achi02", "achi03", "achi04", "achi05", "achi06", "achi07", "achi08", "achi09", "achi10", "achi11", "achi12", "achi13", "achi14", "achi15", "achi16", "achi17", "achi18", "achi19", "achi20", "upgr01", "x10"]:
...
if control == "h" or control ==  "cheat" or control ==  "t" or control ==  "b" or control ==  "b1" or control ==  "s" or control ==  "x10" or control ==  "no x10" or control ==  "b2" or control ==  "b3" or control ==  "achi":
    if control == "h":
       print ("Welcome to army typer! \n If you want to start new game, type (s). If you want to get a point, type (t). If you want to open buy menu, you can type (b). If you want to open achivements menu, you can type (achi)")
    ...
    if control == "b":
        ...
        print(f"  You have {buil02} snipers, sniper will cost you {price_buil02} points, in x10 mode 10 sniper will cost you {x10price_buil02} points, you can buy sniper by typing (b2). Each sniper gains you {gain_each_buil02} points. All snipers gain u {gain_buil02} points.")
        print(f"  You have {buil03} tanks, tank will cost you {price_buil03} points, in x10 mode 10 tanks will cost you {x10price_buil03} points, you can buy tank by typing (b3). Each tank gains you {gain_each_buil03} points. All tanks gain u {gain_buil03} points.")
